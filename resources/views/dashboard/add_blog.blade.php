...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <input type="text" id="hidden" name="content" style="display: none">
                    <input type="text" id="slug" name="slug" style="display: none">
                    <div id="editor">
                    </div>
                    <button id="kirim" type="submit" class="btn btn-primary mt-3">Kirim</button>
                </form>
            </main>
        </div>
    </div>
    ...
    <script>
        CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
            ...
            placeholder: 'Ketikkan Blog disini',
            ...
            kirim.addEventListener('click', function() {
                ...
                slug.value = slug.value.toLowerCase().replaceAll(' ', '-');
                slug.value = slug.value.replaceAll('/', '-');
