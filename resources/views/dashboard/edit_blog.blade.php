                ...
                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="title" id="exampleInputEmail1"
                            value="{{ $blog->title }}" aria-describedby="emailHelp" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <img src="{{ asset($blog->image_path) }}" width="300px" class="img-thumbnail mb-3"
                        alt="{{ $blog->title }}">
                    ...
                    <button id="kirim" type="submit" class="btn btn-primary mt-3 mb-3">Simpan</button>
                </form>
            </main>
        </div>
    </div>
